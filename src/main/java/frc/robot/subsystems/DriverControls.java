...
public class DriverControls extends SubsystemBase{
    ...
    */
    ...
    public double translationY(){
        return -MathUtil.applyDeadband(driverController.getLeftX(), Constants.OperatorConstants.LEFTX_DEADBAND);
    }
    
    public double translationX(){
        return -MathUtil.applyDeadband(driverController.getLeftY(), Constants.OperatorConstants.LEFTY_DEADBAND);
    }
     ...
     public double snapRotation(){
        ...
        double r = MathUtil.applyDeadband(rightJoyPolarCoordinate[0], Constants.OperatorConstants.LEFTX_DEADBAND);
